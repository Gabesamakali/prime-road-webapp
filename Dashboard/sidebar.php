...
<aside class="sidebar">
    ...
    <ul class="menu">
        ...
        <li>
            <a href="../gis/GIS.php" class="<?= basename($_SERVER['PHP_SELF']) == 'GIS.php' ? 'active' : '' ?>">
        ...
        <li>
            <a href="../gis/road_segment.php" class="<?= basename($_SERVER['PHP_SELF']) == 'road_segment.php' ? 'active' : '' ?>">
        ...
        <li>
            <a href="../gis/AssetInventory.php" class="<?= basename($_SERVER['PHP_SELF']) == 'AssetInventory.php' ? 'active' : '' ?>">
